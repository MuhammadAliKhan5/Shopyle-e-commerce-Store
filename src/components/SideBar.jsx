      ...
      <div className="col-span-12 lg:col-span-3 flex flex-col gap-4 h-[520px]">
        ...
        <div className="flex-1 bg-white border border-gray-200 rounded-2xl p-4 shadow-sm overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="group relative rounded-xl overflow-hidden bg-gray-50 border aspect-square cursor-pointer">
                <img src={`/r${i}.png`} className="w-full h-full object-cover group-hover:scale-110 transition-transform" />
              </div>
            ))}
          </div>
        </div>
